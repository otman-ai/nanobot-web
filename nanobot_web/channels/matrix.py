...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install nanobot-web[matrix]"
    ) from e
...
from nanobot_web.config.paths import get_data_dir, get_media_dir
from nanobot_web.utils.helpers import safe_filename
