...
from nanobot_web.cli import commands
...
def mock_prompt_session():
    ...
    with patch("nanobot_web.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nanobot_web.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nanobot_web.cli.commands.PromptSession") as MockSession, \
         patch("nanobot_web.cli.commands.FileHistory") as MockHistory, \
